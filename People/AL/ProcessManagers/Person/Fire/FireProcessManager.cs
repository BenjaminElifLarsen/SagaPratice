...
internal class FireProcessManager : IFireProcessManager
{
    ...
    public void Handler(PersonFiredSuccessed @event)
    {
        ...
        _trackerCollection.UpdateEvent<PersonFiredSuccessed>(DomainEventStatus.Finished);
    ...
    public void Handler(PersonFiredFailed @event)
    {
        ...
        _trackerCollection.UpdateEvent<PersonFiredFailed>(DomainEventStatus.Finished);
