...
public sealed class PersonHiredSucceeded : IDomainEvent<PersonHiredData>
{
    ...
    internal PersonHiredSucceeded(Person aggregate, int version, Guid correlationId, Guid causationId)
