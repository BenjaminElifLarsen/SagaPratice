...
public interface IOperatorService
{
    ...
    Task<Result<OperatorDetails>> GetOperatorDetailsAsync(Guid id); //ids could be used to search in other aggregates via requests or could take the ids and search the other aggregate roots and then combine and send of
