...
public class LicenseTypeAlteredSucceeded : IDomainEvent<LicenseTypeAlteredSuccesedData>
{ //do similarly to the one over in People
    ...
    public LicenseTypeAlteredSucceeded(LicenseType aggregate, int version, bool typeChanged, bool ageRequirementChanged, bool renewPeriodChanged, Guid correlationId, Guid causationId)
    {
